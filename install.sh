...
[[ ! -d "$HOME/.config" ]] && "$HOME/.config"
[[ ! -L "$HOME/.config/i3" ]] && ln -s "$DOTFILES/i3" "$HOME/.config/i3"
[[ ! -L "$HOME/.config/i3/plasma-i3.service" ]] && ln -s "$DOTFILES/i3/plasma-i3.service" "$HOME/.config/i3/plasma-i3.service"
[[ ! -L "$HOME/.config/alacritty" ]] && ln -s "$DOTFILES/alacritty" "$HOME/.config/alacritty"
...
logInfo "installing i3"
source "$DOTFILES/install_scripts/install_i3.sh"
...
logInfo "installing applications"
source "$DOTFILES/install_scripts/install_applications.sh"
